    ...
    return (
        ...
        >
            ...
            <div className="w-[10vw] flex">
                <div className="w-[11.8vh] h-[5.4vh] bg-[rgb(81,0,135)] flex items-center justify-center rounded-3xl text-xl">
                    <h2 className="text-[#F5F0F6] font-semibold">Home</h2>
                </div>
                <div className="w-[5.4vh] h-[5.4vh] bg-[rgb(81,0,135)] rounded-3xl flex justify-center items-center">
                    {/* Account Icon */}
                    <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#F5F0F6">
